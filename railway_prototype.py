...
class RailwayFittingsPrototype:
    ...
    def _decode_qr_from_image(self, image_path):
        try:
            ...
            if decoded_objects:
                ...
                print(f"Successfully decoded QR. Content: {qr_data}")
                return qr_data
            else:
    ...
    def search_menu(self):
        ...
        while True:
            ...
            print("2. Search via QR Scan (by UID)")
            ...
            if choice == '1':
                ...
                image_path = input(f"Enter the path to the QR image (e.g., {QR_CODE_DIR}/QR_...png): ").strip()
                decoded_uid = self._decode_qr_from_image(image_path)
                if decoded_uid:
                    self._search_by_uid(decoded_uid)
            elif choice == '3':
